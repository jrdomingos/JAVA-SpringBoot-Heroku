...
/* harmony import */ var _services_task__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/task */ "./src/app/services/task.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppComponent = /** @class */ (function () {
    function AppComponent(taskService) {
        ...
        this.title = 'frontend';
        this.task = new _services_task__WEBPACK_IMPORTED_MODULE_2__["Task"]();
    ...
    AppComponent.prototype.findAll = function () {
        var _this = this;
        this.taskService.findAll().subscribe(function (res) {
            console.log(res);
            _this.tasks = res;
        });
    };
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_http__WEBPACK_IMPORTED_MODULE_3__["HttpModule"]
            ],
            providers: [],
...
module.exports = __webpack_require__(/*! /home/jr/projects/guesserSpring/front-end/src/main.ts */"./src/main.ts");
